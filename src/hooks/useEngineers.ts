...
export function useEngineers() {
  ...
  const createEngineer = async (engineer: Engineer) => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData?.message ?? '要員の登録に失敗しました。',
        )
      }
  ...
  const updateEngineer = async (updatedEngineer: Engineer) => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/engineers/${updatedEngineer.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData?.message ?? '要員の更新に失敗しました。',
        )
      }
  ...
  const deleteEngineer = async (engineerId: number) => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData?.message ?? '要員の削除に失敗しました。',
        )
      }
  ...
  const restoreEngineer = async (engineerId: number) => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/engineers/${engineerId}/restore`, {
        method: 'PATCH',
      })
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData?.message ?? '要員の復元に失敗しました。',
        )
      }
