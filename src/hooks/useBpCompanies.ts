...
export function useBpCompanies() {
	...
	const createBpCompany = async (
		...
		try {
			...
			const message =
				error instanceof Error ? error.message : "BP企業の登録に失敗しました。";
	...
	const updateBpCompany = async (
		...
		try {
			...
			const message =
				error instanceof Error ? error.message : "BP企業の更新に失敗しました。";
	...
	const deleteBpCompany = async (id: number): Promise<ApiActionResult> => {
		try {
			...
			const message =
				error instanceof Error ? error.message : "BP企業の削除に失敗しました。";
	...
	const restoreBpCompany = async (id: number): Promise<ApiActionResult> => {
		try {
			...
			const response = await fetch(
				`${API_BASE_URL}/bp-companies/${id}/restore`,
				{
					method: "PATCH",
				},
			);
			...
			const message =
				error instanceof Error ? error.message : "BP企業の復元に失敗しました。";
